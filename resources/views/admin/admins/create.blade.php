<x-admin-layout>
    ...
    <div class="py-6">
        <div class="max-w-3xl mx-auto sm:px-6 lg:px-8">
            ...
            <form action="{{ route('admins.store') }}" method="POST" class="bg-white shadow rounded p-6 space-y-4">
                @csrf
                <div>
                ...
                <div class="flex items-center justify-end gap-2">
                    ...
                    <button class="px-4 py-2 bg-indigo-600 text-white rounded hover:bg-indigo-700">Create Admin</button>
                </div>
            </form>
        </div>
    </div>
